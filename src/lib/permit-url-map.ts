...
const PERMIT_PATHS: Record<string, string | null> = {
  ...
  r_end_fam_rifugiato: '/permesso-famigliari-di-persone-con-status-di-rifugiato-o-protezione-sussidiaria.html#rinnovo',
  r_end_affidamento: '/permesso-affidamento-a-familiari-entro-il-quarto-grado.html#rinnovo',
  r_end_ass_minori: '/permesso-assistenza-minore-articolo-31.html#rinnovo',
  ...
  r_end_cure_padre: '/permesso-cure-mediche-padre-di-bambino-minore-di-6-mesi-o-che-sta-per-nascere-in-italia.html#rinnovo',
  r_end_cure_gravidanza: '/permesso-cure-mediche-donna-in-stato-di-gravidanza-o-con-figlio-minore-di-6-mesi.html#rinnovo',
  r_end_sportiva: '/permesso-attivita-sportiva.html#rinnovo',
  r_end_apolidia: '/permesso-apolidia.html#rinnovo',
  r_end_res_elettiva: '/permesso-residenza-elettiva.html#rinnovo',
  r_end_artistico: '/permesso-lavoro-artistico.html#rinnovo',
  r_end_religiosi: '/permesso-motivi-religiosi.html#rinnovo',
  r_end_ricerca: '/permesso-ricerca-scientifica.html#rinnovo',
  ...
  r_end_prosieguo: '/permesso-integrazione-prosieguo-amministrativo.html#rinnovo',
  r_end_figlio_14: '/permesso-figlio-minore-di-piu-di-14-anni-che-vive-con-i-genitori.html#rinnovo',
  r_end_generico: null,
  ...
  c_end_lav_no: null,
  c_end_lav_speciale: '/permesso-lavoro-subordinato-conversione-da-altro-permesso.html',
  c_end_lav_cure: '/permesso-lavoro-subordinato-conversione-da-altro-permesso.html',
  c_end_lav_calam: '/permesso-lavoro-subordinato-conversione-da-altro-permesso.html',
  c_end_lav_minore: '/permesso-lavoro-subordinato-conversione-da-altro-permesso.html',
  c_end_att_ok: '/permesso-attesa-occupazione.html',
  c_end_att_no: null,
  c_end_att_asilo: null,
  c_end_att_incerta: '/permesso-attesa-occupazione.html',
  c_end_att_minore: '/permesso-attesa-occupazione.html',
  c_end_stu_ok: '/permesso-studio-conversione-da-altro-permesso.html',
  c_end_stu_no: null,
  c_end_stu_minore: '/permesso-studio-conversione-da-altro-permesso.html',
  c_end_stu_speciale: '/permesso-studio-conversione-da-altro-permesso.html',
  c_end_fam_ok: '/permesso-famiglia-senza-nullaosta-per-ricongiungimento-coesione-familiare.html',
  c_end_fam_anno: '/permesso-famiglia-senza-nullaosta-per-ricongiungimento-coesione-familiare.html',
