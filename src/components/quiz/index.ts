 ...
 * All question type components for the assessment system
 */
...
export { CoursePrompts } from "./CoursePrompts"
export type { CoursePromptsProps } from "./CoursePrompts"
